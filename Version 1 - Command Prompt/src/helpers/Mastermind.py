...
logs_namescore_path = os.path.join(version1_path, "logs", "Name_Score.txt")
    ...
    def __init__(self):
        while True:
            try:
                ...
                self.num = int(
                    input(
                        "\t\t\t\t\t\t\t\t\t\t\tWhat length would you like to guess\n\n\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t\t"
                    )
                )
                ...
                print(
                    "\t\t\t\t\t\t\t\t\t\t\tMust be between 1 and 6, and connot be letters!"
                )
...
\t\t					_/      _/    _/_/_/  _/_/_/        _/_/    _/_/_/  _/        _/      _/  _/  _/    _/    _/_/_/     \n\
    ...
    def game_play(self):
        ...
        self.print_Mastermind()
        print(
            '\t\t\t\t\t\t\t\t\tPlease enter your guess of %s digits, or enter "q" to quit:\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n\t\tTRY#:\t\t\tGUESSES:\n'
            % (self.num)
        )
            ...
            while True:
                try:
                    ...
                    if self.guess == ("q" or "Q"):
                        ...
                        break
                    if (
                        len(str(self.guess)) > self.num
                        or len(str(self.guess)) < self.num
                    ):
                        raise IndexError
