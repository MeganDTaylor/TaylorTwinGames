...
class Battleship:
    def __init__(self):
        self.frame = Toplevel()
        self.frame.iconbitmap(img_path)
    ...
    def give_directions(self):
        ...
        self.directions_give = Message(
            self.directions,
            text="You have 6 changes to guess the correct location of the battleship\nMake a choice be selecting a tile.",
            width=1000,
            pady=200,
    ...
    def create_board(self):
        self.welcome = Message(
            self.frame, text="Battleship", width=500, font=("parchment", 60)
        )
        self.welcome.grid(row=0, column=0, columnspan=4)
        # Row 1
        self.displayturn = Message(
            self.frame, text=str(self.turn), font=("parchment", 50)
        )
        ...
        self.oneone = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(1, 0),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.onetwo = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(1, 1),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.onetwo.grid(row=1, column=1)
        self.onethree = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(1, 2),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.onefour = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(1, 3),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.onefive = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(1, 4),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.twoone = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(2, 0),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.twotwo = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(2, 1),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.twotwo.grid(row=2, column=1)
        self.twothree = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(2, 2),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.twofour = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(2, 3),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.twofive = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(2, 4),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.twofive.grid(row=2, column=4)
        # Row 3
        self.threeone = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(3, 0),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.threeone.grid(row=3, column=0)
        self.threetwo = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(3, 1),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.threetwo.grid(row=3, column=1)
        self.threethree = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(3, 2),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.threethree.grid(row=3, column=2)
        self.threefour = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(3, 3),
            bg="#%02x%02x%02x" % (18, 29, 111),
            font=("webdings", 20),
        )
        self.threefour.grid(row=3, column=3)
        self.threefive = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(3, 4),
            bg="#%02x%02x%02x" % (18, 29, 111),
            font=("webdings", 20),
        )
        ...
        self.fourone = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(4, 0),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.fourtwo = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(4, 1),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.fourtwo.grid(row=4, column=1)
        self.fourthree = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(4, 2),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.fourthree.grid(row=4, column=2)
        self.fourfour = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(4, 3),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.fourfour.grid(row=4, column=3)
        self.fourfive = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(4, 4),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.fiveone = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(5, 0),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        ...
        self.fivetwo = Button(
            ...
            width=2,
            height=1,
            command=lambda: self.play_game(5, 1),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.fivetwo.grid(row=5, column=1)
        self.fivethree = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(5, 2),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.fivethree.grid(row=5, column=2)
        self.fivefour = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(5, 3),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
        self.fivefour.grid(row=5, column=3)
        self.fivefive = Button(
            self.frame,
            text="",
            width=2,
            height=1,
            command=lambda: self.play_game(5, 4),
            bg="#%02x%02x%02x" % (18, 29, 115),
            font=("webdings", 20),
        )
    ...
    def play_game(self, row, col):
        if self.turn <= 6:
            ...
            for button in self.frame.grid_slaves():
                if (
                    int(button.grid_info()["row"]) == row
                    and int(button.grid_info()["column"]) == col
                ):
                    if (
                        int(button.grid_info()["row"]) == self.ship_row
                        and int(button.grid_info()["column"]) == self.ship_col
                    ):
                        button["text"] = "o"
        ...
        if self.turn == (6):
            ...
            self.playagain.grid(row=7, column=0, columnspan=5)
            self.yes = Button(
                self.frame, text="YES", width=10, command=lambda: self.again()
            )
            self.yes.grid(row=8, column=0, columnspan=3)
            self.no = Button(
                self.frame, text="NO", width=10, command=lambda: self.frame.destroy()
            )
            self.no.grid(row=8, column=2, columnspan=3)
